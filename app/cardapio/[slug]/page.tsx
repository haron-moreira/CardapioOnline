...
export default function CardapioPage() {
    ...
    return (
        <div className={`min-h-screen p-4 sm:p-8 ${tema === 'escuro' ? 'bg-neutral-900 text-white' : 'bg-white text-black'}`}>
            <HeaderSuperior nome_restaurante={response.nome_restaurante} />
            <RestaurantHeader
                ...
                cat.existem_produtos ? (
                    <div key={cat.referencia_categoria}>
                        <h1
                            ...
                            className="px-4 py-2 font-bold mt-10 mb-4 text-xl rounded"
                        >
                            {cat.nome_categoria}
                        </h1>
                            ...
                            {response.produtos
                                ...
                                .map((prato) => (
                                    ...
                                    >
                                        ...
                                        />
                                        <h2 className="pt-2 font-semibold text-lg">
                                            {prato.nome}
                                        </h2>
