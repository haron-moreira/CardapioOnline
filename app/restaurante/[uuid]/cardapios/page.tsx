...
const statuses = {
    ...
    Reembolsado: 'text-gray-600 bg-gray-50 ring-gray-500/10',
    Cancelado: 'text-red-700 bg-red-50 ring-red-600/10',
}
const days = [
    {
        date: 'Today',
...
const clients = [
    {
        ...
        lastInvoice: { date: 'December 13, 2022', dateTime: '2022-12-13', amount: '$2,000.00', status: 'Cancelado' },
    },
    {
        id: 2,
        name: 'SavvyCal',
        imageUrl: 'https://tailwindcss.com/plus-assets/img/logos/48x48/savvycal.svg',
        lastInvoice: { date: 'January 22, 2023', dateTime: '2023-01-22', amount: '$14,000.00', status: 'Pago' },
    },
    {
        id: 3,
        name: 'Reform',
        imageUrl: 'https://tailwindcss.com/plus-assets/img/logos/48x48/reform.svg',
        lastInvoice: { date: 'January 23, 2023', dateTime: '2023-01-23', amount: '$7,600.00', status: 'Pago' },
    },
]
